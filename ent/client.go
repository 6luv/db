...
// QueryManager queries the manager edge of a TourProduct.
func (c *TourProductClient) QueryManager(tp *TourProduct) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := tp.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(tourproduct.Table, tourproduct.FieldID, id),
...
func (c *UserClient) QueryProducts(u *User) *TourProductQuery {
	query := &TourProductQuery{config: c.config}
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
